...
#define MSD3393_CHANNEL_SETTING_VIR_CH_TBL_BYTE_OFFSET                            0
#define MSD3393_CHANNEL_SETTING_VIR_CH_TBL_COUNT                                  44
...
#define MSD3393_TV_CHANNEL_ALL_DATA_START_BYTE_SIZE						12
#define MSD3393_TV_LAST_CHANNEL_ALL_DATA_START_BYTE_SIZE				16

#define MSD3393_TV_CHANNEL_INFO_SERVICE_TYPE_BYTE_OFFSET			0
#define MSD3393_TV_CHANNEL_INFO_MAJOR_CHANNO_HIGH_BYTE_OFFSET		1
#define MSD3393_TV_CHANNEL_INFO_MAJOR_CHANNO_LOW_BYTE_OFFSET		2
#define MSD3393_TV_CHANNEL_INFO_MINOR_CHANNO_HIGH_BYTE_OFFSET		3
#define MSD3393_TV_CHANNEL_INFO_MINOR_CHANNO_LOW_BYTE_OFFSET		4
#define MSD3393_TV_CHANNEL_INFO_IS_SECURE_BYTE_OFFSET				5
#define MSD3393_TV_CHANNEL_INFO_IS_PROME_BYTE_OFFSET				6
#define MSD3393_TV_CHANNEL_INFO_CHNAME_BYTE_OFFSET					7
#define MSD3393_TV_CHANNEL_INFO_CHNAME_BYTE_SIZE					33
#define MSD3393_TV_CHANNEL_INFO_IS_SECURE_DATA						0x10
#define MSD3393_TV_CHANNEL_INFO_NOT_SECURE_DATA						0x00
#define MSD3393_TV_CHANNEL_INFO_DEFAULT_MINOR_CHANNO				0
#define MSD3393_TV_CHANNEL_INFO_DEFAULT_IS_PROME					0
#define MSD3393_TV_CHANNEL_NAME_BYTE_SIZE							8
...
typedef struct stChannelInfo{
	...
	stChannelInfo():isSkip(false), isLock(false),isSelect(false), indexForAtv(DEF_INVALID_VALUE), indexForDtv(DEF_INVALID_VALUE),
		...
		tvMajorNum(DEF_INVALID_VALUE), tvMinorNum(DEF_INVALID_VALUE),isEffective(false){};
}ChannelInfo;
